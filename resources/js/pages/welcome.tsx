        ...
        <>
            ...
            >
                ...
                <header className="absolute top-0 w-full p-6 z-10">
                    <nav className="flex items-center justify-end gap-3 max-w-7xl mx-auto">
                        <ThemeToggle />
                        <LanguageSwitcher />
                        {auth.user ? (
                            <Link
                                href={route('dashboard')}
                                className="font-semibold transition duration-300 ease-in-out px-4 py-2 rounded-md border"
                                style={{
                            ...
                            <>
                                ...
                                <Link
                                    href={route('register')}
                                    className="font-semibold text-white transition duration-300 ease-in-out px-5 py-2 rounded-md shadow-lg"
                ...
                <main className="flex flex-col items-center justify-center min-h-screen p-6">
                    ...
                    >
                        <div className="p-10 md:p-14 text-center flex flex-col items-center">
                            ...
                            <div className="space-y-6 text-lg leading-relaxed" style={{ color: 'var(--page-text-muted)' }}>
                                {locale === 'ar' ? (
                                    <>
                                        <p className="text-xl md:text-2xl font-medium" style={{ color: 'var(--page-text)' }}>
                                        ...
                                        <div
                                            className="p-5 rounded-lg border my-6 shadow-inner"
                                            style={{
                                                backgroundColor: 'var(--page-inner-box)',
                                                borderColor: 'var(--page-border)',
                                            }}
                            ...
                            <div className="mt-12">
                                <Link
                                    href={route('register')}
                                    className="inline-block font-bold transition duration-300 ease-in-out px-8 py-3 rounded-full transform hover:-translate-y-1"
                                    style={{
