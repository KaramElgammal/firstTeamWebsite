...
export default function Password() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('settings.password') || "Password settings"} />
                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>{t('settings.save_password') || 'Save password'}</Button>
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <p className="text-sm text-[#f3b8b1]">{t('settings.saved') || 'Saved'}</p>
                            </Transition>
                        </div>
                    </form>
                </div>
